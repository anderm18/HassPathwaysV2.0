...
const CourseDropdown = () => {
  ...
  return (
    <div
      className="dropdown cursor-pointer flex items-center gap-2 w-[135px] h-10 px-4 py-2.5 bg-white border-solid border border-gray-300 text-gray-500 py-[10px] px-[14px] rounded-lg prevent-select text-xs md:text-sm lg:text-md"
      ref={dropdownRef}
      onClick={() => {
