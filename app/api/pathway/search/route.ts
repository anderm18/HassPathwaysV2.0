    ...
    pathways: [
      {
        ...
        description:
          "In this pathway, students are offered a full range of opportunities to create artwork in visual, electronic, and experimental media; to situate contemporary art and visual culture historically and culturally; and to participate in activist and community-based art practices.",
        clusters: [
          {
            name: "Studio Art",
            courses: [
      ...
      },
      {
        ...
        description:
          "In this pathway, students are offered a full range of opportunities to perform, compose, and record music; to program and develop novel music technologies; to produce and design sound for screen media; and to situate music historically and culturally across multiple genres.",
        clusters: [
          {
            name: "Music & Culture",
            courses: [
  ...
  },
  {
    ...
    pathways: [
      ...
      },
      {
        ...
        compatibleMinor: ["Narrative and Storytelling"],
      },
      {
        ...
        compatibleMinor: ["Writing", "Strategic Communications"],
      },
      {
        ...
        compatibleMinor: ["Media and Culture"],
      },
    ],
  },
  {
    ...
    pathways: [
      {
        ...
        clusters: [
          ...
          {
            name: "Cognitive Science",
            courses: ["PSYC-4370", "PSYC-4410", "COGS-2000", "COGS-4000"],
          },
        ],
        compatibleMinor: [
          "Cognitive Science",
      ...
      },
      {
        ...
        description:
          "In this pathway, students will learn to reason more precisely, think more critically, and ask more penetrating and foundational questions about enduring and contemporary problems in ethics, science, technology, religion, and politics including some of the biggest challenges that humanity currently faces.",
        clusters: [
          {
          ...
          },
          {
            ...
            courses: ["INQR-1140", "PHIL-2000", "PHIL-4000"],
          },
        ],
        compatibleMinor: [
          "Philosophy",
    ...
    pathways: [
      {
        name: "Economics",
        description:
          "Economics is the study of human behavior, incentives, markets, and governments. Students learn the fundamental models and data analytics of decision-making by individuals and firms, market dynamics, policy-making, globalization, financial economics, and more.",
        required: ["INQR-1200"],
        clusters: [
          {
            name: "Economics",
            courses: ["ECON-2000", "ECON-4000"],
          },
        ],
        compatibleMinor: [
          "Economics",
    ...
    pathways: [
      {
        ...
        compatibleMinor: ["Science, Technology, and Society"],
      },
      {
  ...
  },
  {
    ...
    pathways: [
      ...
      },
      {
        name: "Pre-Health",
        description:
          "The Pre-Health pathway is designed for students who are planning to apply to medical school or pursuing other health-related careers. It includes coursework that is required as part of the medical school application process.",
        required: ["PSYC-1200", "STSO-2520"],
        clusters: [
          {
            name: "Pre-Health",
            courses: [
      ...
      },
      {
        name: "History",
        description:
          "The pathway designed for students interested in U.S. and world history. Courses all intersect in that they offer historical perspectives and approaches to thinking about various topics: from music, to technology, to medicine, to broader historical surveys (such as American History).",
        clusters: [
          {
            name: "History",
            courses: [
      ...
      },
      {
        name: "Public Health",
        description:
          "The pathway in Public Health is designed for students interested in health-related careers who wish to develop skills and knowledge about global public health challenges. It also offers important courses for students on a pre-health/pre-med track beyond the pre-health/pre-med pathway.",
        clusters: [
          {
            name: "Public Health",
            courses: [
        ...
        compatibleMinor: ["Public Health"],
      },
      {
        name: "Well-Being: Body and Mind",
        description:
          'How do we cultivate well-being in our lives? What are the relationships between individual, social and ecological health? The "Well-being: Body and Mind" Integrative Pathway explores well-being through theoretical and practical courses across a range of disciplines including philosophy, psychology, science and technology studies, health sciences, and the arts.',
        clusters: [
          {
          ...
          },
          {
            ...
            courses: ["COGS-4610", "COGS-4700"],
          },
          {
            name: "Well-Being: Philosophy",
            courses: ["PHIL-4240", "PHIL-4500", "STSO-4250"],
          },
          {
